...
/* ============================================================
   ESAKO extras (global, all pages):
   1) Floating WhatsApp button
   2) Spanish / English toggle (via Google Translate)
   ============================================================ */
(function () {
  function ready(fn) {
    if (document.body) fn();
  ...
  ready(function () {
    ...
    st.textContent =
      ...
      "body{top:0!important;}#goog-gt-tt,.goog-tooltip,.goog-te-balloon-frame{display:none!important;}" +
  ...
  document.addEventListener("click", function (e) {
    ...
    if (burger) {
      ...
      var chk = nav && nav.querySelector(".nav-check");
    ...
    /* Close the mobile menu after tapping a normal link */
    if (a) {
      var openChk = document.querySelector("nav .nav-check");
      if (openChk && openChk.checked) openChk.checked = false;
    }
  });
})();
